...
namespace Common
{
    ...
    public class TypeHelper
    {
        ...
        /// <param name="defaultValue">默认值</param>
        /// <returns></returns>
        public static float objectTofloat(object s, float defaultValue = 0)
        {
        ...
        {
            if (o != null)
                return StringToBool(o.ToString().ToLower(), defaultValue);
        ...
        /// <param name="defaultValue">默认值</param>
        /// <returns></returns>
        public static string DateTimeToString(string s)
        {
            if (!string.IsNullOrWhiteSpace(s))
            {
                DateTime result;
        ...
        /// <param name="s">目标对象</param>
        /// <returns></returns>
        public static string S_ToString(object o)
        {
            return o + "";
        }
        ...
        /// <param name="s">目标对象</param>
        /// <returns></returns>
        public static string S_NULL(object o)
        {
            if (o.ToString() == "0")
            {
                return "";
